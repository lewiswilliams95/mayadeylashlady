...
<h2 align="left">Testing</h2>
    ...
    Jest was used to test the Javascript.
...
#### First Time Visitor Goals
1. For a First Time Visitor, I have created a website that provides new users with the company's history and about the owner of the business.
- This goal is accomplished on the Home page of the website.
...
3. For a First Time Visitor, I have created a page which shows our services that they provide and our with evidence of this within a gallery .
- This goal is accomplished with the gallery page. Alt text used to describe the image for accessibility throughout.

4. For a First Time Visitor, I have included links to our social media platforms to keep in touch with all news regarding the business.
- All links maintained with the footer of the page.
- All links tested and are working.

5. For a First Time Visitor, I have included a page that will act as a bookings and enquiries page to reach out to the business.
- The booking API works properly.
- the webform works correctly and the user is met with a pop up confirming completion of the form.

6. For a First Time Visitor, I have created a page that acts as a marketing and information page for the upcoming lash academy.
- this is found on the LashAcademy page. 
- Easy to navigate to on the nav bar.
...
1. For Returning Users, I have created a contact page, this will be for both enquiries with the Company  and bookings for appointments.
    ...
    - The bookings API is working on the webpage.
    - There will be links to social media accounts and a phone number for support.

2. For Returning Users, There will be updates regarding the business and the address for the salon.
    - this is contained on the home page and also easily accessible from the footer of all pages.

3. For Returning Users, There will be up to date links to the businesses social platforms.
    - found on all pages contained within the footer.
4. For Returning Users, There will be the front page for the lash academy. At a later date this will include a member login area and access to the courses.
    - Landing page for the lash academy created. the members area will be added at a later date.
...
- [jQuery:](https://jquery.com/)
    - jQuery used throughout for the scripting of JS.
- [SimplyBook REST API](https://www.programmableweb.com/api/simplybook-rest-api)
...
- The section of the README.md regarding making a local clone and creating the github page link was used from the Sample README.md file found on our course content see 
[Here](https://learn.codeinstitute.net/courses/course-v1:codeinstitute+FE+2017_T3/courseware/c75714c9636b4cf59120d60acbec6ffd/f851a16813f14b3aae7bd1e6560443cd/)  